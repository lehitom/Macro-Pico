...
# ENCODERS
encoders.pins = ((board.GP11, board.GP10, board.GP9, False), (board.GP14, board.GP13, board.GP12, False),(board.GP17, board.GP16, board.GP15, False),)
...
encoders.map = [    ((KC.VOLD, KC.VOLU, KC.MUTE), (KC.VOLD, KC.VOLU, KC.MUTE), (KC.VOLD, KC.VOLU, KC.MUTE)),#           (KC.RGB_VAD,    KC.RGB_VAI,     KC.RGB_TOG)),   # MACROS
